<html>
    ...
    <body onload="hide('galettes'); hide('salades')">
        <div class="card-deck">
            <div class="card">
                <img class="card-img-top" src="images/Photos crêperie/fois-gras.jpg" alt="fois-gras image">
                <div class="card-body">
                    <button type="button" id="button" onclick="scrollDown('galettes'); showImage('galettes')" class="btn btn-primary darleston brown">Les galettes</button>
                </div>
            </div>
            <div class="card">
                <img class="card-img-top" src="images/Photos crêperie/fermiere.jpg" alt="salade image">
                <div class="card-body">
                    <button type="button" onclick="hide('galettes')" class="btn btn-primary darleston brown">Les salades</button>
                </div>
            </div>
            <div class="card">
        ...
        <img id="galettes" src="imagescarte/galettes.png" alt="galettes" >
        <img id="salades" src="imagescarte/salades.png" alt="salades" >
